        ...
        <div class="p-6 bg-white border-b border-gray-200">
          ...
          <form method="POST" action="{{ route('products.update', $product->id) }}">
            ...
            <div class="mb-3">
              ...
              <textarea name="description_product" class="form-control" style="height: 100px">{{$product->description_product}}</textarea>
            </div>
            <div class="mb-3">
              <label for="price_product" class="form-label">Prix</label>
              <input value="{{$product->price_product}}" name="price_product" type="number" class="form-control">
            </div>
            <div class="mb-3">
              <label for="quantity_product" class="form-label">Quantité</label>
              <input value="{{$product->quantity_product}}" name="quantity_product" type="number" class="form-control">
            </div>
